...
current_dir = Path('/home/worrellie/Documents/phd/autoencoder/Datasets/z09_v3-001')
...
if not fits_files:
    ...
    print(f"Plotting: {random_file.name}")

    with fits.open(random_file) as hdul:
        ...
        plt.suptitle(f"File: {random_file.name}", 
